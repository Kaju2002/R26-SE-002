...
import ApplicationNotificationRow from './ApplicationNotificationRow';
...
export default function SwipeableApplicationRow({
  item,
  showDivider,
  onPress,
  onDelete,
    ...
    >
      ...
      >
        ...
        <Pressable
          ...
          accessibilityLabel={`Delete ${item.jobTitle}`}
          style={({ pressed }) => [
            styles.deleteColumn,
            pressed && { opacity: 0.9 },
          ]}
