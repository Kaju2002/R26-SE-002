...
export default function EmployerShell({
  ...
  const navItems = [
    ...
    { href: `${config.basePath}/inchat`, label: 'InChat' },
    { href: `${config.basePath}/email`, label: 'Email' },
    { href: `${config.basePath}/jobs`, label: 'Jobs' },
    { href: `${config.basePath}/applicants`, label: 'Applicants' },
    { href: `${config.basePath}/profile`, label: 'Profile' },
  ] as const;
            ...
            <div className="mb-2 flex items-center gap-3">
              ...
              <div className="min-w-0 flex-1">
                <p
                  ...
                  style={{ color: colors.navy, fontFamily: 'var(--font-poppins)' }}
                >
                  {portal === 'company' && user.company?.name
                    ? user.company.name
                    : user.fullName}
                </p>
                <p
