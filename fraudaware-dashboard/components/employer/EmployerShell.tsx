...
export default function EmployerShell({
  ...
  const navItems: { href: string; label: string; icon: NavIconId }[] = [
    ...
    { href: `${config.basePath}/interviews`, label: 'Interviews', icon: 'interviews' },
    { href: `${config.basePath}/inchat`, label: 'InChat', icon: 'inchat' },
    { href: `${config.basePath}/email`, label: 'Email', icon: 'email' },
    { href: `${config.basePath}/templates`, label: 'Templates', icon: 'templates' },
    { href: `${config.basePath}/analytics`, label: 'Analytics', icon: 'analytics' },
    { href: `${config.basePath}/team`, label: 'Team', icon: 'team' },
    { href: `${config.basePath}/billing`, label: 'Billing', icon: 'billing' },
