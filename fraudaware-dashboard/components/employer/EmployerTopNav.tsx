...
export default function EmployerTopNav({
  ...
  const appsLinks = [
    ...
    { href: `${basePath}/jobs`, label: 'Jobs', subtitle: 'Post and manage openings' },
    { href: `${basePath}/applicants`, label: 'Applicants', subtitle: 'Review candidates' },
    { href: `${basePath}/interviews`, label: 'Interviews', subtitle: 'Schedule calendar' },
    { href: `${basePath}/templates`, label: 'Templates', subtitle: 'Email & InChat replies' },
    { href: `${basePath}/analytics`, label: 'Analytics', subtitle: 'Views & apply rates' },
    { href: `${basePath}/team`, label: 'Team', subtitle: 'Workspace members' },
    { href: `${basePath}/billing`, label: 'Billing', subtitle: 'Plans & invoices' },
  ...
  const profileDropdown = (
    <div className="relative" ref={menuRef}>
      ...
      >
        <UserAvatar user={user} size={32} fallbackLetter={shortLabel[0]} />
        {!mobile ? (
          <svg
        ...
        >
          <div className="border-b border-[#EEF0F8] px-3 py-2.5">
            <div className="flex items-center gap-2.5">
              <UserAvatar user={user} size={36} fallbackLetter={shortLabel[0]} />
